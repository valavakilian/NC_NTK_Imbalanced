...
params = {
        ...
        "imb_type": 'step',
        "save_path":'',
        "pretrain_path": '/scratch/st-cthrampo-1/vaalaa/NC_NTK/NC_CDT_resnet_CIFAR_R10/cdt_gamma_0.5_version_0model.pth',
        "data_path" :'./data',
        "workers": 4,
...
# train_loader = torch.utils.data.DataLoader(
#     train_dataset, batch_size=params['batch_size'], shuffle=(params["train_sampler"] is None), pin_memory=True, sampler=params["train_sampler"] )
...
model2 = torch.load(params['pretrain_path'], map_location=torch.device('cpu'))
...
f = open("/scratch/st-cthrampo-1/vaalaa/NC_NTK/NTK_retrain_CDT_R_" + str(R)+ "_NTK_Prints.txt", "w")
f.write("Create File!\n")
f.flush()

save_graph = graphs()
root_path = "/scratch/st-cthrampo-1/vaalaa/NC_NTK/NTK_retrain_CDT_R_" + str(R) + "/cdt_gamma_" + str(0.5) + "_version_" + str(0)
# root_path = "./here"
save_path = root_path
