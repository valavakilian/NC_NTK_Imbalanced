# -*- coding: utf-8 -*-
"""LDT_resnet32_cifar10_R10.ipynb
...
R = 10
f = open("/scratch/st-cthrampo-1/vaalaa/NC_NTK/LDT_resnet18_cifar10_R" + str(R)+ "_NTK_Prints.txt", "w")
f.write("Create File!\n")
f.flush()
...
num_version = 1
versions = [0]
f.write("Starting Experiments for ldt_gamma = " + str(gamma_values)  + " num_version = " + str(num_version) + " \n")
f.flush()
...
for version in versions:
    for gamma in gamma_values:
        ...
        f.write("ldt_gamma = " + str(gamma)  + " version = " + str(version) + " \n")
        f.flush()

        print("+" * 200)
        print("LDT Gamma = " + str(gamma))
        print("+" * 200)
        '''
        ...
        root_path = "/scratch/st-cthrampo-1/vaalaa/NC_NTK/NC_LDT_resnet_CIFAR_R" + str(R) + "/ldt_gamma_" + str(gamma) + "_version_" + str(version)
        # root_path = "./here"
